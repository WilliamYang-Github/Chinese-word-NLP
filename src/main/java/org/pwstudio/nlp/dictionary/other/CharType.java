 ...
 *
 * <copyright file="CharType.java">
 * This source is subject to the Apache License 2.0. see http://www.apache.org/licenses/LICENSE-2.0
 * </copyright>
 */
package org.pwstudio.nlp.dictionary.other;
...
public class CharType
{
    ...
    {
        type = new byte[65536];
        logger.info("字符类型对应表开始加载 " + PwNLP.Config.CharTypePath);
        long start = System.currentTimeMillis();
        ByteArray byteArray = ByteArray.createByteArray(PwNLP.Config.CharTypePath);
        if (byteArray == null)
        {
            try
            {
            ...
            {
                throw new IllegalArgumentException("字符类型对应表 " + PwNLP.Config.CharTypePath + " 加载失败： " + TextUtility.exceptionToString(e));
            }
        }
...
//        System.out.print("int[" + typeList.size() + "][3] array = \n");
        DataOutputStream out = new DataOutputStream(new FileOutputStream(PwNLP.Config.CharTypePath));
