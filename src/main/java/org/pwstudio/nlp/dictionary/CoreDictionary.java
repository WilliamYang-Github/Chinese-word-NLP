 ...
 *
 * <copyright file="CoreDictionaryACDAT.java">
...
import org.pwstudio.nlp.dictionary.base.Attribute;
...
public class CoreDictionary
{
    ...
    public final static String path = PwNLP.Config.CoreDictionaryPath;
    ...
    public static final int NX_WORD_ID = getWordID(Predefine.TAG_OTHER);
	public static final int MQ_WORD_ID = getWordID(Predefine.TAG_QUANTIFIER);
