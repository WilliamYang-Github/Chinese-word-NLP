...
public class SimplifiedToHongKongChineseDictionary extends BaseChineseDictionary
{
    ...
    static
    {
        ...
        String datPath = PwNLP.Config.tcDictionaryRoot + "s2hk";
        if (!load(datPath, trie))
        {
            ...
            if (!load(s2t, false, PwNLP.Config.tcDictionaryRoot + "s2t.txt") ||
                    !load(t2hk, false, PwNLP.Config.tcDictionaryRoot + "t2hk.txt"))
            {
