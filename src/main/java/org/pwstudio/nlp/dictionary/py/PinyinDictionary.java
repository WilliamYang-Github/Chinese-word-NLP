 ...
 *
 * <copyright file="PinyinDictionary.java">
...
import org.pwstudio.nlp.corpus.dictionary.StringDictionary;
...
public class PinyinDictionary
{
    ...
    static
    {
        ...
        if (!load(PwNLP.Config.PinyinDictionaryPath))
        {
            throw new IllegalArgumentException("拼音词典" + PwNLP.Config.PinyinDictionaryPath + "加载失败");
        }

        logger.info("拼音词典" + PwNLP.Config.PinyinDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
    }
    ...
    public static void parseText(char[] charArray, AhoCorasickDoubleArrayTrie.IHit<Pinyin[]> processor)
    {
        trie.parseText(charArray, processor);
    }
