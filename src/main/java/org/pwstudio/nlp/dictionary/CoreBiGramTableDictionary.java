 ...
 *
 * <copyright file="CoreBiGramDictionary.java">
...
public class CoreBiGramTableDictionary
{
    ...
    static
    {
        String path = PwNLP.Config.BiGramDictionaryPath;
    ...
    {
        String datPath = PwNLP.Config.BiGramDictionaryPath + ".table" + Predefine.BIN_EXT;
...
//        }
    ...
    {
        String biGramDictionaryPath = PwNLP.Config.BiGramDictionaryPath;
