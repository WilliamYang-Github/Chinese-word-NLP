 ...
 *
 * <copyright file="BigramDependencyModel.java">
 * This source is subject to the Apache License 2.0. see http://www.apache.org/licenses/LICENSE-2.0
 * </copyright>
 */
package org.pwstudio.nlp.model.bigram;
...
import org.pwstudio.nlp.corpus.dependency.model.WordNatureWeightModelMaker;
...
public class BigramDependencyModel
{
    ...
    static
    {
        ...
        if (load(PwNLP.Config.WordNatureModelPath))
        {
            logger.info("加载依存句法二元模型" + PwNLP.Config.WordNatureModelPath + "成功，耗时：" + (System.currentTimeMillis() - start) + " ms");
        }
        else
        {
            logger.warning("加载依存句法二元模型" + PwNLP.Config.WordNatureModelPath + "失败，耗时：" + (System.currentTimeMillis() - start) + " ms");
        }
    }
