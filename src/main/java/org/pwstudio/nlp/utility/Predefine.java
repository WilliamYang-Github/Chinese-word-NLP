...
public class Predefine
{
    ...
    public static String HANLP_ROOT_PATH;
    ...
    public final static String[] POSTFIX_MUTIPLE = {"半岛","草原","城区","大道","大堤","大公国","大桥","地区",
        "帝国","渡槽","港口","高速公路","高原","公路","公园","共和国","谷地","广场",
        "国道","海峡","胡同","机场","集镇","教区","街道","开发区","口岸","码头","煤矿",
        "牧场","农场","盆地","片区","平原","丘陵","群岛","沙漠","沙洲","山脉","山丘","社区",
        "水库","隧道","特区","铁路","新村","新区","雪峰","盐场","盐湖","渔场","直辖市",
        "自治区","自治县","自治州"};
     ...
     * 专有名词 nz
     */
    public final static String TAG_NEW = "未##新";
    /**
     * 其它 nx
     */
